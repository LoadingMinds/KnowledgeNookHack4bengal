...
type Video = {
  ...
  return (
    <div className="bg-black w-full h-full text-text px-20 pb-5">
      <div className="mt-12 bg-primary-foreground px-4 md:px-8 py-12 rounded-3xl w-full text-text">
        <h1 className="text-4xl md:text-6xl font-bold mb-4 ">{subject}</h1>
        <p className="text-lg md:text-2xl mt-2 text-white/60 bg-secondary py-2 px-4 max-w-fit rounded-2xl flex">
          Total Number of Days: <span className="text-red text-3xl pl-3 ">{totalDays}</span>
        </p>
      </div>
      ...
      <div className="flex md:flex-row flex-col justify-between gap-4 mt-4 items-center">
        ...
        <div className="flex justify-center text-center">
          ...
          <Button className="mx-1 px-3 py-1 rounded bg-red text-white hover:bg-red">
            {currentPage}
          </Button>
          <Button
            className="mx-1 px-3 py-1 rounded bg-gray-200 text-gray-800 hover:bg-gray-300"
